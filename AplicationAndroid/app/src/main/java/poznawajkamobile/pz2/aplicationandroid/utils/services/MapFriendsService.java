...
public class MapFriendsService extends Service implements MapFriendsListner {
    ...
    private final IBinder mBinder = new MapFriendsBinder();
    ...
    public void start(String login) {
        ...
        dir.mkdirs();
        MapFriendsRequest task = new MapFriendsRequest(this);
        task.execute(login, dir.getPath());
    }

    @Override
    public void onFriendsFind(String result) {
        working = false;
    ...
    public class MapFriendsBinder extends Binder {
        public MapFriendsService getService() {
            return MapFriendsService.this;
        }
    }
